...
public class UITextListener extends BasicLabelUI implements ComponentListener {

    public static LabelUI labelUI = new UITextListener();
    ...
    private int getLineCount(FontMetrics metrics, Rectangle bounds) {
        int textHeight = bounds.height;
        return textHeight / metrics.getHeight();
    }
